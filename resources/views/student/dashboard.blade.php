                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-md-6">
                            <div class="card h-100 border-0 rounded-4 shadow-hover overflow-hidden position-relative">
                                <div class="subject-header" style="height: 50px; background: linear-gradient(135deg, #4e73df, #764ba2);"></div>
                                <div class="card-body bg-white position-relative p-4" style="margin-top: -45px; border-radius: 20px;">
                        ...
                        <div class="col-md-6">
                            <div class="card h-100 border-0 rounded-4 shadow-hover overflow-hidden position-relative">
                                <div class="subject-header" style="height: 50px; background: linear-gradient(135deg, #f093fb, #f5576c);"></div>
                                <div class="card-body bg-white position-relative p-4" style="margin-top: -45px; border-radius: 20px;">
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="icon-wrapper me-3">
                                    ...
                                    <h2 class="fw-bold text-success text-center mb-1">{{ $stats['total_materials'] }}</h2>
...
.animate-card { animation: slideInUp 0.6s ease-out; }
@keyframes slideInUp { from { opacity: 0; transform: translateY(30px); } to { opacity: 1; transform: translateY(0); } }

.shadow-hover { transition: all 0.3s ease; }
.shadow-hover:hover { transform: translateY(-6px); box-shadow: 0 10px 25px rgba(0, 0, 0, 0.15); }
...
.hover-schedule { transition: all 0.25s ease; }
.hover-schedule:hover { background-color: #f8f9fa; transform: scale(1.01); }
</style>
@endsection
