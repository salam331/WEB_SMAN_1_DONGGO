        ...
        <div class="card border-0 shadow-sm rounded-3">
            <div class="card-header bg-primary text-white d-flex align-items-center justify-content-between">
                <h5 class="mb-0 fw-semibold">
                    <i class="fas fa-chalkboard-teacher me-2"></i> Tambah Data Guru
                </h5>
            ...
            <div class="card-body bg-light bg-gradient p-4">
                <form action="{{ route('admin.teachers.store') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    <div class="row g-4">
                        <!-- Nama -->
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold text-secondary">
                                <i class="fas fa-id-badge me-1 text-primary"></i> NIP
                            </label>
