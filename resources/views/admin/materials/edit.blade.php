    ...
    <div class="container-fluid">
        <div class="card border-0 shadow-sm rounded-3">
            ...
            <div class="card-body bg-light bg-gradient p-4">
                ...
                <!-- Form -->
                <form action="{{ route('admin.materials.update', $material) }}" method="POST" enctype="multipart/form-data" class="p-2">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-switch mt-2">
                                <input class="form-check-input" type="checkbox" id="is_published" name="is_published"
                                    value="1" {{ old('is_published', $material->is_published) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="description" name="description" class="form-control border-0 shadow-sm rounded-3 p-2"
                                placeholder="Masukkan deskripsi materi pembelajaran..." rows="4">{{ old('description', $material->description) }}</textarea>
                        ...
                        <div class="col-md-12">
                            <label for="file_path" class="form-label fw-semibold text-secondary">
                                <i class="fas fa-file-upload me-1 text-primary"></i> Unggah File (Opsional)
                            </label>
                            ...
                            @if($material->file_path)
                                <div class="alert alert-info rounded-3 shadow-sm mb-3">
                                    ...
                                    <a href="{{ route('admin.materials.download', $material) }}" target="_blank" class="text-info fw-semibold">
                                        <i class="fas fa-download me-1"></i>{{ basename($material->file_path) }}
                                    </a>
                                    <br>
                                    <small class="text-muted">Upload file baru untuk mengganti file ini</small>
                                </div>
                            @endif
