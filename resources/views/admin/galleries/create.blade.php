            ...
            <div class="col-lg-12 col-md-10">
                <div class="card shadow-lg border-0 rounded-4">
                    <div
                        ...
                        <h4 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Tambah Galeri Baru</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="description" name="description" rows="4"
                                    ...
                                    placeholder="Tuliskan deskripsi singkat galeri...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            {{-- Upload Gambar --}}
                            <div class="mb-4">
                                <label for="image" class="form-label fw-semibold">Gambar Galeri <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="category" name="category"
                                    ...
                                    value="{{ old('category') }}" placeholder="Contoh: Kegiatan Sekolah, Olahraga, dll">
                                @error('category')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-check mb-4">
                                ...
                                <div class="form-text">Jika dicentang, galeri akan ditampilkan di halaman publik.</div>
                            </div>
                        </div>
