                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="email"
                                                    ...
                                                    name="email" value="{{ old('email', $school->email) }}" required>
                                                @error('email')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <label for="headmaster_name" class="form-label">Kepala Sekolah <span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control @error('headmaster_name') is-invalid @enderror"
                                                id="headmaster_name" name="headmaster_name"
                                                value="{{ old('headmaster_name', $school->headmaster_name) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('accreditation', $school->accreditation) }}" required>
                                                @error('accreditation')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        {{-- <div class="col-md-6"> --}}
                                            <div class="mb-3">
                                                <label for="total_achievements" class="form-label">Total Prestasi <span
                                                        class="text-danger">*</span></label>
                                                <input type="number"
                                                    class="form-control @error('total_achievements') is-invalid @enderror"
                                                    id="total_achievements" name="total_achievements"
                                                    value="{{ old('total_achievements', $school->total_achievements) }}" required>
                                                @error('total_achievements')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        {{-- </div> --}}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('hero_description') is-invalid @enderror"
                                            ...
                                            placeholder="Deskripsi singkat untuk hero section">{{ old('hero_description', $school->hero_description) }}</textarea>
                                    ...
                                    <div class="mb-3">
                                                ...
                                                @foreach($features as $index => $feature)
                                                    <div class="feature-item border rounded p-3 mb-3">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                <button type="button"
                                                                    class="btn btn-danger btn-sm remove-feature">Hapus</button>
                                                            </div>
                                                        </div>
                                                        <div class="mt-2">
                                                            <textarea class="form-control" name="features[{{ $index }}][desc]"
                                                                rows="2"
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm" id="add-feature">Tambah
                                            Fitur</button>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                                ...
                                                @foreach($statistics as $index => $stat)
                                                    <div class="statistic-item border rounded p-3 mb-3">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                <button type="button"
                                                                    class="btn btn-danger btn-sm remove-statistic">Hapus</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                            id="add-statistic">Tambah Statistik</button>
                                    </div>
                                </div>
                            </div>
                        </div>
