...
<div class="container mx-auto p-4">
    ...
    <form method="post" action="{{ route('admin.teachers.store') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nip" class="border p-2 w-full" value="{{ old('nip') }}" />
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="jabatan" class="border p-2 w-full" value="{{ old('jabatan') }}" />
        </div>
        <div class="mb-3">
            <label class="block mb-1">Bio</label>
            <textarea name="bio" class="border p-2 w-full">{{ old('bio') }}</textarea>
        </div>
        <div>
